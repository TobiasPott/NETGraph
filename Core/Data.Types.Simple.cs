...
namespace NETGraph.Data.Simple
{
    ...
    {
        public IntData(int scalar) : base(DataTypes.Int, scalar) { }
        public IntData(IEnumerable<int> values, bool isRezisable) : base(DataTypes.Int, values, isRezisable) { }
        public IntData(IEnumerable<KeyValuePair<string, int>> namedValues, bool isRezisable) : base(DataTypes.Int, namedValues, isRezisable) { }
